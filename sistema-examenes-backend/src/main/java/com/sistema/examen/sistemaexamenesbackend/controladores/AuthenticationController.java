...
import com.sistema.examen.sistemaexamenesbackend.configuraciones.JwtUtils;
import com.sistema.examen.sistemaexamenesbackend.exeptions.UsuarioFoundExeption;
import com.sistema.examen.sistemaexamenesbackend.modelo.JwtRequest;
import com.sistema.examen.sistemaexamenesbackend.modelo.JwtResponse;
...
public class AuthenticationController {
    ...
    public ResponseEntity<?> generarToken(@RequestBody JwtRequest jwtRequest) throws Exception {
        ...
        }catch (UsuarioFoundExeption exception){
